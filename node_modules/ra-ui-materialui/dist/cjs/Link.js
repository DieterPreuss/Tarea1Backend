...
var Link = function (props) {
    ...
    return (React.createElement(StyledLink, __assign({ to: to, className: (0, clsx_1.default)(exports.LinkClasses.link, className) }, rest), children));
};
exports.Link = Link;
var PREFIX = 'RaLink';
exports.LinkClasses = {
...
var MuiRouterLink = function (props) { return (React.createElement(material_1.Link, __assign({ component: react_router_dom_1.Link }, props))); };
var StyledLink = (0, material_1.styled)(MuiRouterLink)(function (_a) {
    var _b;
    var theme = _a.theme;
    return (_b = {},

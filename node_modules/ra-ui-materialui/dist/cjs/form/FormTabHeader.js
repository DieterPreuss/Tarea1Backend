...
var FormTabHeader = function (_a) {
    var _b;
    var label = _a.label, value = _a.value, icon = _a.icon, className = _a.className, onChange = _a.onChange, syncWithLocation = _a.syncWithLocation, rest = __rest(_a, ["label", "value", "icon", "className", "onChange", "syncWithLocation"]);
    ...
    return (React.createElement(material_1.Tab, __assign({ label: (0, react_1.isValidElement)(label) ? label : translate(label, { _: label }), value: value, icon: icon, className: (0, clsx_1.default)('form-tab', className, (_b = {},

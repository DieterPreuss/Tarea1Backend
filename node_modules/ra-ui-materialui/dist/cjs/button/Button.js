...
var Button = function (props) {
    ...
    return isXSmall ? (label && !disabled ? (React.createElement(material_1.Tooltip, { title: translatedLabel },
        React.createElement(material_1.IconButton, __assign({ "aria-label": translatedLabel, className: className, color: color }, rest, linkParams, { size: "large" }), children))) : (React.createElement(material_1.IconButton, __assign({ className: className, color: color, disabled: disabled }, rest, linkParams, { size: "large" }), children))) : (React.createElement(StyledButton, __assign({ className: className, color: color, size: size, "aria-label": translatedLabel, disabled: disabled, startIcon: alignIcon === 'left' && children ? children : undefined, endIcon: alignIcon === 'right' && children ? children : undefined }, rest, linkParams), translatedLabel));
};

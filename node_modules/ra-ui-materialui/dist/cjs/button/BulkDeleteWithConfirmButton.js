...
var BulkDeleteWithConfirmButton = function (props) {
    ...
    var _g = (0, ra_core_1.useSafeSetState)(false), isOpen = _g[0], setOpen = _g[1];
    ...
    var _h = (0, ra_core_1.useDeleteMany)(resource, { ids: selectedIds, meta: mutationMeta }, __assign({ onSuccess: function () {
            refresh();

...
var Tab = function (_a) {
    ...
    var renderHeader = function () { return (React.createElement(material_1.Tab, __assign({ key: "tab-header-".concat(value), label: typeof label === 'string'
            ? translate(label, { _: label })
            : label, value: value, icon: icon, className: (0, clsx_1.default)('show-tab', className) }, (syncWithLocation ? propsForLink : {}), rest))); };

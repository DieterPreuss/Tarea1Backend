...
var ShowViewGuesser = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        if (record && !child) {
            ...
            console.log("Guessed Show:\n\nimport { ".concat(components.join(', '), " } from 'react-admin';\n\nexport const ").concat(inflection_1.default.capitalize(inflection_1.default.singularize(resource)), "Show = () => (\n    <Show>\n").concat(inferredChild.getRepresentation(), "\n    </Show>\n);"));
        }
    }, [record, child, resource]);
    return React.createElement(ShowView_1.ShowView, __assign({}, props), child);
};

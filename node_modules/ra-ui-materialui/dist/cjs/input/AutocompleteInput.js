...
var AutocompleteInput = function (props) {
    var _a;
    var choicesProp = props.choices, className = props.className, _b = props.clearOnBlur, clearOnBlur = _b === void 0 ? true : _b, _c = props.clearText, clearText = _c === void 0 ? 'ra.action.clear_input_value' : _c, _d = props.closeText, closeText = _d === void 0 ? 'ra.action.close' : _d, create = props.create, createLabel = props.createLabel, createItemLabel = props.createItemLabel, createValue = props.createValue, _e = props.debounce, debounceDelay = _e === void 0 ? 250 : _e, _f = props.defaultValue, defaultValue = _f === void 0 ? '' : _f, emptyText = props.emptyText, _g = props.emptyValue, emptyValue = _g === void 0 ? '' : _g, fieldOverride = props.field, format = props.format, helperText = props.helperText, idOverride = props.id, inputText = props.inputText, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, isRequiredOverride = props.isRequired, label = props.label, limitChoicesToValue = props.limitChoicesToValue, matchSuggestion = props.matchSuggestion, margin = props.margin, fieldStateOverride = props.fieldState, _h = props.filterToQuery, filterToQuery = _h === void 0 ? DefaultFilterToQuery : _h, formStateOverride = props.formState, _j = props.multiple, multiple = _j === void 0 ? false : _j, noOptionsText = props.noOptionsText, onBlur = props.onBlur, onChange = props.onChange, onCreate = props.onCreate, _k = props.openText, openText = _k === void 0 ? 'ra.action.open' : _k, optionText = props.optionText, optionValue = props.optionValue, parse = props.parse, resourceProp = props.resource, shouldRenderSuggestions = props.shouldRenderSuggestions, setFilter = props.setFilter, size = props.size, sourceProp = props.source, _l = props.suggestionLimit, suggestionLimit = _l === void 0 ? Infinity : _l, TextFieldProps = props.TextFieldProps, translateChoice = props.translateChoice, validate = props.validate, variant = props.variant, rest = __rest(props, ["choices", "className", "clearOnBlur", "clearText", "closeText", "create", "createLabel", "createItemLabel", "createValue", "debounce", "defaultValue", "emptyText", "emptyValue", "field", "format", "helperText", "id", "inputText", "isFetching", "isLoading", "isRequired", "label", "limitChoicesToValue", "matchSuggestion", "margin", "fieldState", "filterToQuery", "formState", "multiple", "noOptionsText", "onBlur", "onChange", "onCreate", "openText", "optionText", "optionValue", "parse", "resource", "shouldRenderSuggestions", "setFilter", "size", "source", "suggestionLimit", "TextFieldProps", "translateChoice", "validate", "variant"]);
    var _m = (0, ra_core_1.useChoicesContext)({
        choices: choicesProp,
        isFetching: isFetchingProp,
        isLoading: isLoadingProp,
        resource: resourceProp,
        source: sourceProp,
    }), allChoices = _m.allChoices, isLoading = _m.isLoading, fetchError = _m.error, resource = _m.resource, source = _m.source, setFilters = _m.setFilters, isFromReference = _m.isFromReference;
    var translate = (0, ra_core_1.useTranslate)();
    var finalEmptyText = emptyText !== null && emptyText !== void 0 ? emptyText : '';
    var finalChoices = isRequiredOverride || multiple
        ? allChoices
        : [
            (_a = {},
    ...
    var _o = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, id: idOverride, field: fieldOverride, fieldState: fieldStateOverride, formState: formStateOverride, onBlur: onBlur, onChange: onChange, parse: (parse !== null && parse !== void 0 ? parse : isFromReference) ? convertEmptyStringToNull : undefined, format: (format !== null && format !== void 0 ? format : isFromReference) ? convertNullToEmptyString : undefined, resource: resource, source: source, validate: validate }, rest)), id = _o.id, field = _o.field, isRequired = _o.isRequired, _p = _o.fieldState, error = _p.error, invalid = _p.invalid, isTouched = _p.isTouched, isSubmitted = _o.formState.isSubmitted;
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (emptyValue == null) {
            throw new Error("emptyValue being set to null or undefined is not supported");
        }
        // eslint-disable-next-line eqeqeq
    ...
    var _q = (0, ra_core_1.useSuggestions)({
        choices: finalChoices,
    ...
    var _r = (0, react_1.useState)(''), filterValue = _r[0], setFilterValue = _r[1];
    ...
    var _s = (0, useSupportCreateSuggestion_1.useSupportCreateSuggestion)({
        create: create,
    ...
    }), getCreateItem = _s.getCreateItem, handleChangeWithCreateSupport = _s.handleChange, createElement = _s.createElement, createId = _s.createId;
    ...
    var doesQueryMatchSelection = (0, react_1.useCallback)(function (filter, eventType) {
...
var convertEmptyStringToNull = function (value) { return (value === '' ? null : value); };
var convertNullToEmptyString = function (value) { return (value === null ? '' : value); };

...
var CheckboxGroupInput = function (props) {
    ...
    (0, ra_core_1.warning)(source === undefined, "If you're not wrapping the CheckboxGroupInput inside a ReferenceArrayInput, you must provide the source prop");
    (0, ra_core_1.warning)(!isLoading && allChoices === undefined, "If you're not wrapping the CheckboxGroupInput inside a ReferenceArrayInput, you must provide the choices prop");
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", margin: margin, error: fetchError || ((isTouched || isSubmitted) && invalid), className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className) }, sanitizeRestProps(rest)),
        ...
        React.createElement(FormGroup_1.default, { row: row }, allChoices === null || allChoices === void 0 ? void 0 : allChoices.map(function (choice) { return (React.createElement(CheckboxGroupInputItem_1.CheckboxGroupInputItem, __assign({ key: (0, get_1.default)(choice, optionValue), choice: choice, id: id, onChange: handleCheck, optionText: optionText, optionValue: optionValue, translateChoice: translateChoice, value: value }, sanitizeRestProps(rest)))); })),

...
var NumberInput = function (_a) {
    ...
    var _d = (0, ra_core_1.useInput)(__assign({ defaultValue: defaultValue, resource: resource, source: source, validate: validate }, rest)), field = _d.field, _e = _d.fieldState, error = _e.error, invalid = _e.invalid, isTouched = _e.isTouched, isSubmitted = _d.formState.isSubmitted, id = _d.id, isRequired = _d.isRequired;

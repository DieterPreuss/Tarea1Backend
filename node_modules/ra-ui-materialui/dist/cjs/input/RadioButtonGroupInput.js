...
var RadioButtonGroupInput = function (props) {
    ...
    (0, ra_core_1.warning)(source === undefined, "If you're not wrapping the RadioButtonGroupInput inside a ReferenceInput, you must provide the source prop");
    (0, ra_core_1.warning)(allChoices === undefined, "If you're not wrapping the RadioButtonGroupInput inside a ReferenceInput, you must provide the choices prop");
    ...
    return (React.createElement(StyledFormControl, __assign({ component: "fieldset", className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), margin: margin, error: fetchError || ((isTouched || isSubmitted) && invalid) }, sanitizeRestProps(rest)),
        ...
        React.createElement(material_1.RadioGroup, __assign({ id: id, row: row }, field, sanitizeRestProps(rest)), allChoices.map(function (choice) { return (React.createElement(RadioButtonGroupInputItem_1.RadioButtonGroupInputItem, { key: (0, get_1.default)(choice, optionValue), choice: choice, optionText: optionText, optionValue: optionValue, source: source, translateChoice: translateChoice })); })),

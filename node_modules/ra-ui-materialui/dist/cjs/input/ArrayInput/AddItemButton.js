...
var AddItemButton = function (props) {
    var add = (0, useSimpleFormIterator_1.useSimpleFormIterator)().add;
    return (React.createElement(button_1.IconButtonWithTooltip, __assign({ label: "ra.action.add", size: "small", onClick: function () { return add(); }, color: "primary" }, props),
        React.createElement(AddCircleOutline_1.default, { fontSize: "small" })));
};

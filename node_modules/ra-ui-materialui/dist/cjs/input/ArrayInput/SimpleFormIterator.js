...
var SimpleFormIterator = function (props) {
    var _a = props.addButton, addButton = _a === void 0 ? React.createElement(AddItemButton_1.AddItemButton, null) : _a, _b = props.removeButton, removeButton = _b === void 0 ? React.createElement(RemoveItemButton_1.RemoveItemButton, null) : _b, _c = props.reOrderButtons, reOrderButtons = _c === void 0 ? React.createElement(ReOrderButtons_1.ReOrderButtons, null) : _c, children = props.children, className = props.className, resource = props.resource, source = props.source, disabled = props.disabled, disableAdd = props.disableAdd, disableRemove = props.disableRemove, disableReordering = props.disableReordering, inline = props.inline, _d = props.getItemLabel, getItemLabel = _d === void 0 ? false : _d, fullWidth = props.fullWidth, sx = props.sx;
    var _e = (0, useArrayInput_1.useArrayInput)(props), append = _e.append, fields = _e.fields, move = _e.move, remove = _e.remove;
    ...
    return fields ? (React.createElement(SimpleFormIteratorContext_1.SimpleFormIteratorContext.Provider, { value: context },
        React.createElement(Root, { className: (0, clsx_1.default)(className, fullWidth && 'fullwidth', disabled && 'disabled'), sx: sx },
            ...
            !disabled && !disableAdd && (React.createElement("div", { className: useSimpleFormIteratorStyles_1.SimpleFormIteratorClasses.add }, (0, react_1.cloneElement)(addButton, {

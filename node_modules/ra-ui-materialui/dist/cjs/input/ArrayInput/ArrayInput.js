...
var ArrayInput = function (props) {
    var _a;
    var className = props.className, defaultValue = props.defaultValue, label = props.label, isFetching = props.isFetching, isLoading = props.isLoading, children = props.children, helperText = props.helperText, record = props.record, resourceFromProps = props.resource, source = props.source, validate = props.validate, variant = props.variant, disabled = props.disabled, _b = props.margin, margin = _b === void 0 ? 'dense' : _b, rest = __rest(props, ["className", "defaultValue", "label", "isFetching", "isLoading", "children", "helperText", "record", "resource", "source", "validate", "variant", "disabled", "margin"]);
    ...
    var _c = (0, react_hook_form_1.useFormContext)(), getFieldState = _c.getFieldState, formState = _c.formState, getValues = _c.getValues, register = _c.register, unregister = _c.unregister;
    ...
    var _d = getFieldState(source, formState), isDirty = _d.isDirty, error = _d.error;
    if (isLoading) {
    ...
    return (React.createElement(Root, __assign({ fullWidth: true, margin: margin, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), exports.ArrayInputClasses.root, className), error: (isDirty || isSubmitted) && !!error }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest)),
        ...
        !!((isDirty || isSubmitted) && !!error) || helperText ? (React.createElement(material_1.FormHelperText, { error: (isDirty || isSubmitted) && !!error },
            React.createElement(InputHelperText_1.InputHelperText, { touched: isDirty || isSubmitted, 
                ...
                error: error.root ? (_a = error.root) === null || _a === void 0 ? void 0 : _a.message : error === null || error === void 0 ? void 0 : error.message, helperText: helperText }))) : null));
};

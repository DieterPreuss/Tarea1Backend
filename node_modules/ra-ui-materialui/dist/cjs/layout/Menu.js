...
var Menu = function (props) {
    ...
    var hasDashboard = props.hasDashboard, _b = props.children, children = _b === void 0 ? __spreadArray([
        ...
        .map(function (name) { return (React.createElement(MenuItemLink_1.MenuItemLink, { key: name, to: createPath({
            resource: name,
            type: 'list',
        }), state: { _scrollToTop: true }, primaryText: getResourceLabel(name, 2), leftIcon: resources[name].icon ? ((0, react_1.createElement)(resources[name].icon)) : (React.createElement(ViewList_1.default, null)) })); }), true) : _b, className = props.className, rest = __rest(props, ["hasDashboard", "children", "className"]);

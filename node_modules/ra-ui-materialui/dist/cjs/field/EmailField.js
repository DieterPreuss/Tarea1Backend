...
exports.EmailField = (0, react_1.memo)(function (props) {
    ...
    return (React.createElement(material_1.Link, __assign({ className: className, href: "mailto:".concat(value), onClick: stopPropagation, variant: "body2" }, (0, sanitizeFieldRestProps_1.sanitizeFieldRestProps)(rest)), value));
});
exports.EmailField.propTypes = types_1.fieldPropTypes;
exports.EmailField.displayName = 'EmailField';

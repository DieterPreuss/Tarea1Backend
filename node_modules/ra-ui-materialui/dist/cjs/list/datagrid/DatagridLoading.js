...
var DatagridLoading = function (_a) {
    ...
    return oneSecondHasPassed ? (React.createElement(material_1.Table, { className: (0, clsx_1.default)(useDatagridStyles_1.DatagridClasses.table, className), size: size },

...
var DatagridCell = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(TableCell_1.default, __assign({ className: (0, clsx_1.default)(className, field.props.cellClassName), align: field.props.textAlign, ref: ref }, rest), field));
});

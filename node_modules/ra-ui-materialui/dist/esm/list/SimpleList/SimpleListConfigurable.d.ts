...
export declare const SimpleListConfigurable: {
    ...
    propTypes: {
        ...
        linkType: import("prop-types").Requireable<string | boolean | ((...args: any[]) => any)>;
        primaryText: import("prop-types").Requireable<string | import("prop-types").ReactElementLike | ((...args: any[]) => any)>;
        rightAvatar: import("prop-types").Requireable<(...args: any[]) => any>;
        rightIcon: import("prop-types").Requireable<(...args: any[]) => any>;
        secondaryText: import("prop-types").Requireable<string | import("prop-types").ReactElementLike | ((...args: any[]) => any)>;
        tertiaryText: import("prop-types").Requireable<string | import("prop-types").ReactElementLike | ((...args: any[]) => any)>;

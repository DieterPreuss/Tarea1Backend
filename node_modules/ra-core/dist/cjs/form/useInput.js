...
var useInput = function (props) {
    var defaultValue = props.defaultValue, format = props.format, id = props.id, isRequiredOption = props.isRequired, name = props.name, onBlur = props.onBlur, onChange = props.onChange, parse = props.parse, source = props.source, validate = props.validate, options = __rest(props, ["defaultValue", "format", "id", "isRequired", "name", "onBlur", "onChange", "parse", "source", "validate"]);
    ...
    var _a = (0, react_hook_form_1.useController)(__assign({ name: finalName, defaultValue: (0, get_1.default)(record, source, defaultValue), rules: {
        ...
        } }, options)), controllerField = _a.field, fieldState = _a.fieldState, formState = _a.formState;

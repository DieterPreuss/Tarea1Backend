 ...
 *
 */
export declare const useCreateContext: <RecordType extends RaRecord = RaRecord>(props?: Partial<CreateControllerResult<RecordType>>) => Partial<CreateControllerResult<RecordType>>;

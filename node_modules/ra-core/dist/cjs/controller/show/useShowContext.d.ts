 ...
 *
 */
export declare const useShowContext: <RecordType extends RaRecord = any>(props?: Partial<ShowControllerResult<RecordType>>) => Partial<ShowControllerResult<RecordType>>;
